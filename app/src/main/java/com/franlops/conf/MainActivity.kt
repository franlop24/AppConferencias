    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val jsonArr2 = JSONArray(
            "[\n" +
                    ...
                    "            {\n" +
                    "                \"datetime\" : 1564837200,\n" +
                    "                \"description\" : \"Hoy quiero hablarles de los dos tipos de personas que existen en el mundo, hay personas que consumen y hay personas que crean, todos somos de las primeras, todo el tiempo estamos consumiendo, consumimos tecnología, consumimos libros, películas, series, comida, el problemas es queno todo el mundo esta creando y cuando me refiero a crear me refiero a crear productos servicios, eventos, cosas que le aporten algo a la comunidad o al mundo, porque es un problema queno tanta gente este creando como laque esta consumiendo, porque le estamos quitando al mundo mas de lo que le dejamos, no estamos dejando este mundo mejor de como lo encontramos, eso genera consumismo y eso es un problema.\",\n" +
                    "                \"speaker\" : \"Cesar Fajardo\",\n" +
                    "                \"tag\" : \"Content\",\n" +
                    "                \"title\" : \"Un 'gracias' vale más que un millónde views\"\n" +
                    "            },\n" +
                    "            {\n" +
                    "                \"datetime\" : 1564858800,\n" +
                    ...
                    "            {\n" +
                    "                \"datetime\" : 1564840800,\n" +
                    "                \"description\" : \"Les quiero comentar de cómo se pueden convertir en un MVP, en el MVP que el mundo necesita, haciéndose una pregunta, ¿Quiénes saben que es un MVP?, quiero comentarles como poder hacer el MVP desu equipo de desarrollo.\",\n" +
                    "                \"speaker\" : \"Pablo Villanueva\",\n" +
                    "                \"tag\" : \"Desarrollo\",\n" +
                    "                \"title\" : \"Cómo convertirte enla persona más valiosa de una empresa\"\n" +
                    "            },\n" +
                    "            {\n" +
                    "                \"datetime\" : 1564860600,\n" +
                    ...
                    "            {\n" +
                    "                \"datetime\" : 1564848000,\n" +
                    "                \"description\" : \"Somos una empresa enfocada en el desarrollo de aplicaciones móviles del lado dela ingeniería y tuvimos por primera vez a una diseñadora en el equipo, al principio la veíamos como un adherido al equipo, luego empezamos un proyecto y ahora vengo a comentarles lo que pasó con la comunicación con personas que son de otras áreas.\",\n" +
                    "                \"speaker\" : \"Jorge García\",\n" +
                    "                \"tag\" : \"Git\",\n" +
                    "                \"title\" : \"Git, la base dela colaboración mucho más allá del código\"\n" +
                    "            },\n" +
                    "            {\n" +
                    "                \"datetime\" : 1564855200,\n" +
                    "                \"description\" : \"Tuve una idea de negocio de vender las imágenes de un teléfono, más de 1 personas me dijo que es la idea más estúpida que haya escuchado, pero yo estaba viendo el futuro que los teléfonos estaban marcando tendencia y que quizá hace años el que uno pueda vender sus fotos a una empresa grande haya sido una locura, pero hoy endía puedes convertir la cámara de tu teléfono un negocio.\",\n" +
                    ...
                    "            {\n" +
                    "                \"datetime\" : 1564844400,\n" +
                    "                \"description\" : \"Uno de los ejercicios hechos por la mayoría de los speakers profesionales, para mejorar como dan un mensaje, la premisa es fácil, no poner atenciónen lo queestán diciendo, sino en cómo lo están diciendo y vengo a compartirles algunas técnicas que aprendí.\",\n" +
                    "                \"speaker\" : \"Isis García\",\n" +
                    "                \"tag\" : \"Voz\",\n" +
                    ...
                    "            {\n" +
                    "                \"datetime\" : 1564833600,\n" +
                    "                \"description\" : \"El título dela charla se llama Workshops de alto impacto para ideas de alto impacto, yo pienso en mi experiencia personalen el banco, mas bien son Workshops de alto impacto enla vida, yo entré a BBVA hace 3 años, soy diseñadora industrial dela UNAM, empecé como todos con un trabajo pequeño, muy duro encontrar mi primer trabajo y me pagaban una miseria y ustedes debieron vivir algo así, entonces BBVA me dio la oportunidad de entrar a trabajar a un lugar decente y vengo a compartirles acerca de mi experiencia.\",\n" +
                    ...
                    "            {\n" +
                    "                \"datetime\" : 1564851600,\n" +
                    "                \"description\" : \"Hoy les voy a hablar de 5 formas de mentir con estadística.  Vamos a hablar de distintos métodos estadísticos quese utilizan y para quese utilizan en el diario vivir y tecnología.\",\n" +
